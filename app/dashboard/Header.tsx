      ...
      <div className='h-full w-1/2 rounded-l-full bg-[linear-gradient(to_top_right,_var(--tertiary),_var(--secondary),_var(--primary))] shadow-lg float-right flex justify-end items-center px-10'>
        <div className='header_admin' >
          ...
          <div className='header_adminContent'>
            ...
            <button className='text-lg px-5 py-2 rounded-md outline-none border-none hover:bg-[#fff] hover:text-[var(--primary)] duration-300 bg-[var(--primary)] text-white flex items-center gap-3' onClick={onLogout}>Logout <FaSignOutAlt size={25} /></button>
          </div>
        </div>
      </div>
    </div>
