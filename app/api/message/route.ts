...
export async function POST(request: NextRequest) {
  try {
    ...
    const mailDetails = {
      from: `"Impact Makers Events - Website" <${process.env.EMAIL_TEST_USERNAME}>`, // sender address
      ...
      html: `
                    ...
                    <body>
                        <div align="center">
                            <img src="https://res.cloudinary.com/drp73bqti/image/upload/v1759359278/impact/logo_card_m8uvnj.png" alt="Impact Makers Events Logo">
                        </div>
